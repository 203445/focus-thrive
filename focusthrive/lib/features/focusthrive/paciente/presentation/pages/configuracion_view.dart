...
class DeletePacientetView extends StatefulWidget {
  final String id;

  const DeletePacientetView({super.key, required this.id});
  @override
  _DeleteAccountViewState createState() => _DeleteAccountViewState();
}

class _DeleteAccountViewState extends State<DeletePacientetView> {
