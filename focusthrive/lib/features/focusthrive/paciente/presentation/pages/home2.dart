...
import '../../../cita/domain/entities/cita.dart';
...
class HomeP extends StatefulWidget {
  ...
  @override
  State<HomeP> createState() => _HomeState();
}
...
class _HomeState extends State<HomeP> {
  ...
  void initState() {
    super.initState();
    context.read<PacienteBloc>().add(GetPaciente(id: ''));
  }
