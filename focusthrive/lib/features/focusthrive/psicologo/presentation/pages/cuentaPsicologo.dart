...
class CuentaPsicologo extends StatefulWidget {
  final Psicologo psicologo;

  const CuentaPsicologo({
    super.key,
...
class _CuentaPState extends State<CuentaPsicologo> {
  ...
  void initState() {
    super.initState();
    nombreController.text = widget.psicologo.nombre;
    apellidoController.text = widget.psicologo.apellidos;
    correoController.text = widget.psicologo.correo;
    telefonoController.text = widget.psicologo.telefono;
  }
