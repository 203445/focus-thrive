...
class DetallePedidoTarjeta extends StatefulWidget {
  const DetallePedidoTarjeta({Key? key}) : super(key: key);
      ...
      setState(() {
        ...
        Future.delayed(Duration(seconds: 2), () {
          setState(() {
            ...
            // Navigator.push(
            //   context,
            //   MaterialPageRoute(builder: (context) => const PagoTarjeta()),
            // );
          });
        });
      });
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                // Navigator.push(
                //   context,
                //   MaterialPageRoute(builder: (context) => const DetallePedido()),
                // );
              },
